# 학교 전체 공지
GENERAL = "https://www.smu.ac.kr/lounge/notice/notice.do"
...
HI = "https://www.smu.ac.kr/hi/community/notice.do" # 휴면지능정보공
...
# 학과 공지 배열
DEPARY = [KJC, BIZ, ECO, NEW, COM, HI, GAME, CS, ANI, ELEC, ELOC, BIO, CEE, ICH, FOOD, CLOT, SMPE, DAN, FINE, LAD, MUS, HIS, CC, LIB, SPA, PUB, FAM, SDMS, KOED, ENED, PEDA, MAED]

# 파일 저장용 배열
GENFIARY = ['gen']
DEPFIARY = ['kjc', 'biz', 'eco', 'new', 'com', 'hi', 'game', 'cs', 'ani', 'elec', 'eloc', 'bio', 'cee', 'ich', 'food', 'clot', 'smpe', 'dan', 'fine', 'lad', 'mus', 'his', 'cc', 'lib', 'spa', 'pub', 'fam', 'sdms', 'koed', 'ened', 'peda', 'maed']

# 구글 스프레드시트 -> 파일 읽기
DEPDICTARY = {"한콘": "kjc", "경영": "biz", "eco": "경제금융", "new": "글로벌경영", "com": "융합경영", "hi": "휴면지능정보공", "game": "게임", "cs": "컴퓨터과학", "ani": "애니", "elec": "전기공", "eloc": "융합전자공", "bio": "생명공", "cee": "화학에너지공", "ich": "화공신소재", "food": "식품영양", "clot": "의류", "smpe": "스포츠건강", "dan": "무용예술", "fine": "조형예술", "lad": "생활예술", "mus": "음악", "his": "역사콘텐츠", "cc": "지적재산권", "lib": "문헌정보", "spa": "공간환경", "pub": "공공인재", "fam": "가족복지", "sdms": "국가안보", "koed": "국어교육", "ened": "영어교육", "peda": "교육", "maed": "수학교육"}

# 파일 경로 / 루트 폴더까지만 지정
FILEPATH = "/home/phoi/Documents/smu_scrap/"